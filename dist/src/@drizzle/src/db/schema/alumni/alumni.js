...
exports.alumniToOrganizationRelations = (0, drizzle_orm_1.relations)(exports.alumniToOrganization, ({ one, many }) => ({
    ...
    feedComment: many(feed_1.feedComment),
...
exports.userOtp = (0, pg_core_1.pgTable)('userOtp', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
...
exports.userOtpRelations = (0, drizzle_orm_1.relations)(exports.userOtp, ({ one }) => ({
    user: one(exports.alumni, {
        fields: [exports.userOtp.user],
        references: [exports.alumni.id],
    }),
}));
